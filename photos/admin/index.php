...
<head>
	...
	<div id="columns">
		<?php
			$sql = "SELECT * FROM jv_photos WHERE jv_Status = 'I' ORDER BY jv_DateTime DESC";
			$resp = mysql_query($sql, $link);
			while($row = mysql_fetch_array($resp)){
				echo "<div class='pin'>";
				echo "<img src='../".$row[1]."' />";
        echo "<p>Si <input name='status' type='radio' value='".$row[0]."' /> No <input name='status' type='radio' value='No' /></p>";
