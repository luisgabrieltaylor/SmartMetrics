...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo $WEB->pluginsDirServ."/iCheck/square/blue.css";?>">
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>smart</b> MetriX</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="<?php echo $WEB->includesDirServ."/process_sessions.php"; ?>" method="post">
